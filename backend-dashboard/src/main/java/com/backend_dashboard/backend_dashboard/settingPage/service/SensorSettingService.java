...
public class SensorSettingService {
    ...
    public List<SensorDisplayDto> getSensorList(String sensorType, String zoneId) {
        ...
        if(sensorType != null && zoneId != null) {
            basicSensors = sensorSummaryRepository.findDistinctBySensorTypeAndZoneId(sensorType, zoneId);
        } else if(sensorType != null) {
            basicSensors = sensorSummaryRepository.findDistinctBySensorType(sensorType);
        } else if(zoneId != null) {
            basicSensors = sensorSummaryRepository.findDistinctByZoneId(zoneId);
        } else {
