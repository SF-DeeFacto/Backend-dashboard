...
public interface SensorSummaryRepository extends JpaRepository<SensorSummary, Long> {
    ...
    List<SensorInfoDto> findDistinctBySensorType(String sensorType);
    List<SensorInfoDto> findDistinctByZoneId(String zoneId);
    List<SensorInfoDto> findDistinctBySensorTypeAndZoneId(String sensorType, String zoneId);
}
